...
function master_problem_local(params::NetworkInvestmentParams, sol::CCGSolutionInfo, iter::Int64, timelimit, gap, big_M)
    ...
    @constraints(masterproblem, begin
        ...
        [k in eachindex(sol.bases_constraints), e in 1:params.num_edges], y[e] + ξbases_proj[k][e] <= 1
    ...
    @objective(masterproblem, Min, params.repair_cost'x + params.transport_cost'y)
