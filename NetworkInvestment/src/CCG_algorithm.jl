...
function CCG(params::NetworkInvestmentParams, iter_max::Int64, multi_cut::Bool, timelimit::Float64, mp_timelimit::Float64, mp_gap::Float64, big_M::Float64, sp_tol::Float64)
