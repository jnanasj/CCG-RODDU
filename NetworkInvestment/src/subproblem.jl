...
function subproblems_local(multi_cut::Bool, params::NetworkInvestmentParams, MPSol::MPSolutionInfo, iter::Int64, constraint_tol::Float64=1e-5)
    ...
    if status == MOI.OPTIMAL
        cut_id = 1
        for n in 1:params.num_edges
            @objective(subproblem, Max, MPSol.y_sol[n] + ξ[n] - 1)
