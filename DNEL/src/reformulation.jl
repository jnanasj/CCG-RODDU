function reformulation(params::GeneralModelParameters, timelimit, gap)
    ...
    reformulation_solution.num_variables_bin = JuMP.num_constraints(reformulation, VariableRef, MOI.ZeroOne)
    reformulation_solution.num_variables_cont = num_variables(reformulation) - reformulation_solution.num_variables_bin
