...
function CCG_projection(params::GeneralModelParameters, iter_max::Int64, multi_cut::Bool, timelimit::Float64, mp_timelimit::Float64, mp_gap::Float64, big_M::Float64, sp_tol::Float64)
    CCGSol = CCGSolutionInfo() # initialization with no vertices
    for iter in 1:iter_max
        # solve master problem
        MPSol = master_problem_projection(params, CCGSol, iter, mp_timelimit, mp_gap, big_M)
        ...
        if SPSol.objective <= sp_tol
            ...
            CCGSol.num_variables_cont = MPSol.num_variables_cont
            CCGSol.num_variables_bin = MPSol.num_variables_bin
